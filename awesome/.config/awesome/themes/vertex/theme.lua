...
theme.widget_cpu                                = theme.icon_dir .. "cpu_widget.png"
theme.tooltip_border_color                      = theme.fg_focus
theme.tooltip_border_width                      = theme.border_width
theme.widget_mem                                = os.getenv("HOME") .. ".config/awesome/themes/multicolor/icons/mem.png"
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#e0da37", "RAM " .. mem_now.used .. "M "))
    end
})
